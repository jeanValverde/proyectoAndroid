...
public class activityHorarioInto extends AppCompatActivity {
    ...
    private activityHorarioInto.ListAdapter listAdapter;
    private ArrayList<activityHorarioInto.Info> listData = new ArrayList<activityHorarioInto.Info>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_horario_into);

        Intent recibir = getIntent();
        idUsuario = recibir.getStringExtra("idUsuario");
        idTarea = recibir.getStringExtra("idTarea");

         dia = (TextView) findViewById(R.id.tareaNombreView);
         descripcion = (TextView) findViewById(R.id.descripcionTareaView);
         incio = (TextView) findViewById(R.id.HoraInicioTareaView);
         fin = (TextView) findViewById(R.id.horaTerminoHorario);

        ImageButton atras = (ImageButton) findViewById(R.id.atrasViewHorario);
        ImageButton crearLista = (ImageButton) findViewById(R.id.crearLista);
        ...
        listView.setListener(new OnSwipeListItemClickListener() {
            ...
            public boolean OnLongClick(View view, int index) {
                AlertDialog.Builder ab = new AlertDialog.Builder(activityHorarioInto.this);
            ...
            public void OnControlClick(int rid, View view, int index) {
                ...
                switch (rid){
                    case R.id.modify:
                        ab = new AlertDialog.Builder(activityHorarioInto.this);
                        ab.setTitle("Modify");
        ...
        atras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activityHorarioInto.this, ActivityHorario.class);
                intent.putExtra("idUsuario", idUsuario);
                startActivity(intent);
            }
        });
        ...
        crearLista.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(activityHorarioInto.this, ActivityCrearListaTarea.class);
                intent.putExtra("idUsuario", idUsuario);
    ...
    private class GetDataLocal extends AsyncTask<String, Void, Boolean> {
       ...
       public void rellenarDatos(ArrayList<ListaTarea> listaTareas){
           ...
           for (ListaTarea lista : listaTareas ) {
               activityHorarioInto.Info info = new activityHorarioInto.Info();
            ...
            listAdapter = new activityHorarioInto.ListAdapter(listData);
    ...
    class ListAdapter extends com.example.jean.proyectoandroid.SwipeList.SwipeListAdapter {
        private ArrayList<activityHorarioInto.Info> listData;
        public ListAdapter(ArrayList<activityHorarioInto.Info> listData){
            this.listData= (ArrayList<activityHorarioInto.Info>) listData.clone();
        }
        @Override
        public int getCount() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            activityHorarioInto.ViewHolder viewHolder = new activityHorarioInto.ViewHolder();
            if(convertView == null){
                ...
                viewHolder = (activityHorarioInto.ViewHolder) convertView.getTag();
            }
            ...
            if (listData.get(position).listaTarea.getEstado().equals("activo")) {
                viewHolder.imagen.setBackground(AppCompatResources.getDrawable(activityHorarioInto.this , R.drawable.iconcancel));
                viewHolder.imagen.setBackgroundTintList(getApplicationContext().getResources().getColorStateList(R.color.rojo));



            }else{
                viewHolder.imagen.setBackground( AppCompatResources.getDrawable(activityHorarioInto.this, R.drawable.iconcheck));
            }
