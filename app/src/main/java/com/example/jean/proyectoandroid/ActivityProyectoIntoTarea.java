...
public class ActivityProyectoIntoTarea extends AppCompatActivity {
    ...
    private ActivityProyectoIntoTarea.ListAdapter listAdapter;
    private ArrayList<ActivityProyectoIntoTarea.Info> listData = new ArrayList<ActivityProyectoIntoTarea.Info>();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_proyecto_into_tarea);
        ...
        dia = (TextView) findViewById(R.id.proyectoTareaIntoNombre);
        descripcion = (TextView) findViewById(R.id.proyectoTareaIntoDescripcion);
        incio = (TextView) findViewById(R.id.proyectoTareaIntoInicio);
        fin = (TextView) findViewById(R.id.proyectoTareaIntoFin);

        ImageButton atras = (ImageButton) findViewById(R.id.atrasProyectoTareaInto);
        ImageButton crearLista = (ImageButton) findViewById(R.id.crearProyectoIntoActividad);
        ...
        listView.setListener(new OnSwipeListItemClickListener() {
            ...
            public boolean OnLongClick(View view, int index) {
                AlertDialog.Builder ab = new AlertDialog.Builder(ActivityProyectoIntoTarea.this);
            ...
            public void OnControlClick(int rid, View view, int index) {
                ...
                switch (rid){
                    case R.id.modify:
                        ab = new AlertDialog.Builder(ActivityProyectoIntoTarea.this);
                        ab.setTitle("Modify");
        ...
        atras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActivityProyectoIntoTarea.this, ActivityProyectoInto.class);
                intent.putExtra("idUsuario", idUsuario);
        ...
        crearLista.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ActivityProyectoIntoTarea.this, ActivityCrearListaTarea.class);
    ...
    private class GetDataLocal extends AsyncTask<String, Void, Boolean> {
        ...
        public void rellenarDatos(ArrayList<ListaTarea> listaTareas){
            ...
            for (ListaTarea lista : listaTareas ) {
                ActivityProyectoIntoTarea.Info info = new ActivityProyectoIntoTarea.Info();
            ...
            listAdapter = new ActivityProyectoIntoTarea.ListAdapter(listData);
    ...
    class ListAdapter extends com.example.jean.proyectoandroid.SwipeList.SwipeListAdapter {
        private ArrayList<ActivityProyectoIntoTarea.Info> listData;
        public ListAdapter(ArrayList<ActivityProyectoIntoTarea.Info> listData){
            this.listData= (ArrayList<ActivityProyectoIntoTarea.Info>) listData.clone();
        }
        @Override
        public int getCount() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ActivityProyectoIntoTarea.ViewHolder viewHolder = new ActivityProyectoIntoTarea.ViewHolder();
            if(convertView == null){
                ...
                viewHolder = (ActivityProyectoIntoTarea.ViewHolder) convertView.getTag();
            }
            ...
            if (listData.get(position).listaTarea.getEstado().equals("activo")) {
                viewHolder.imagen.setBackground(AppCompatResources.getDrawable(ActivityProyectoIntoTarea.this , R.drawable.iconcancel));
                viewHolder.imagen.setBackgroundTintList(getApplicationContext().getResources().getColorStateList(R.color.rojo));



            }else{
                viewHolder.imagen.setBackground( AppCompatResources.getDrawable(ActivityProyectoIntoTarea.this, R.drawable.iconcheck));
            }
